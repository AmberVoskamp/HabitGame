...
namespace DTT.UI.ProceduralUI.Tests
{
    ...
    public class Test_RoundedImageEditor
    {
        ...
        /// </summary>
        private static readonly string[] buildinExtraResourcePath = new string[]
        {
        ...
        public void Setup()
        {
            Canvas[] objects = Object.FindObjectsOfType<Canvas>();
        ...
        public IEnumerator TestInspectPrefabNoCanvasMissingError()
        {
            ...
            _ = PrefabUtility.SaveAsPrefabAsset(Selection.activeGameObject, $"Assets/{name}.prefab", out _);
            yield return null;
            ...
            _ = AssetDatabase.DeleteAsset($"Assets/{name}.prefab");
        }

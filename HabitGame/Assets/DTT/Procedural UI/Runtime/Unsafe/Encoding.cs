...
namespace DTT.UI.ProceduralUI.Unsafe
{
    ...
    public static unsafe class Encoding
    {
        ...
        public static float EncodeFloats(float a, float b)
        {
            ...
            // Save this one as is.
            uint aInt = (uint)Mathf.FloorToInt(a);

            // Shift this value into the other side of the integer.
            uint bInt = ((uint)Mathf.FloorToInt(b)) << 16;
        ...
        {
            return *(uint*)&value; // Reinterpret address of float as that of an unsigned integer.
        }
        ...
        {
            return *(float*)&value; // Reinterpret address of an unsigned integer as that of a float.
        }
    }
}
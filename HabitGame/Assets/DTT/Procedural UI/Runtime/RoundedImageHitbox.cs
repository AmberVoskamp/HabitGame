...
namespace DTT.UI.ProceduralUI
{
    ...
    public class RoundedImageHitbox
    {
        ...
        /// </summary>
        public Rect HitboxRect => new(_roundedImage.rectTransform.rect.position, _roundedImage.GetImageSize());
        ...
        {
            ReadOnlyDictionary<Corner, float> radii = _roundedImage.GetCornerRounding();
            ...
            return (!_roundedImage.UseHitboxOutside && !_roundedImage.UseHitboxInside) || HitTest(position, HitboxRect.size, rounding, borderRadius, _roundedImage.DistanceFalloff);
        }
        ...
        private float RoundedBoxSDF(Vector2 samplePoint, Vector2 size, Vector4 radii)
        {
            ...
            Vector2 absoluteSameplePosition = new(Mathf.Abs(samplePoint.x), Mathf.Abs(samplePoint.y));

...
namespace DTT.Utils.EditorUtilities
{
    ...
    public static class EditorLayoutUtility
    {
        ...
        {
            ContextDropdown dropdown = new(position);
        ...
        public static ContextDropdownBuilder ContextDropdown()
        {
            return ContextDropdown(null);
        }
        ...
        /// <returns>The builder object to create the contextual dropdown.</returns>
        public static ContextDropdownBuilder ContextDropdown(Rect? position)
        {
            return new ContextDropdownBuilder(position);
        }
        ...
        {
            ExtendedDropdown dropdown = new(name, position, state);
        ...
        {
            return new ExtendedDropdownBuilder(name, position, state);
        }
    }
}
